...
def get_help(message):
    if len(message.text.split()) == 1:
        ...
        resp += '    <b>/all [group] [week=0]</b> - показать всё расписание для указанной группы\n'
        resp += '    <b>/[weekday] [group] [week=0]</b> - показать расписание для указанной группы в указанный день\n'
